<template lang="pug">
  div
    ...
    div(style='margin-bottom: 15px')
      ...
      |  
      input#from_date(type='text', style='position: relative; top: 25px; height: 0px; width:0px; border: 0px;')
      |  
      button#from.btn.btn-primary
      |  to 
      input#to_date(type='text', style='position: relative; top: 25px; height: 0px; width:0px; border: 0px;')
      |  
      button#to.btn.btn-primary(name='to')
    p.alert.alert-warning(style='display: none') No transactions were found for the specified time period
    table.table.table-striped.table-hover.report(style='cursor: pointer; display: none')
      thead
        tr
          th Time
          th Rate
